...
that occasional attacks were evenly distributed throughout the territory in 2019,
with systematic attacks focused on northern Italy
(where the companies with the highest turnover are present). 
While Table.~\ref{tab:table5} shows that, already in the first months of 2020,
...
\begin{table}[ht]
  ...
  \resizebox{1\textwidth}{!}{
	...
	\caption{Distribution of digital attacks (detected by the respondents) wrt.\ geographical area, in 2019. The percentages of central Italy are 
	very different from the others because the organizations responding from that geographical area were much fewer than the rest 
